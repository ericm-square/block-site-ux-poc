...
import { i as isTouchEvent, g as getCoordsFromEvent } from './utils.js';
import { a as hsvToRgb, h as hsvToHex, p as parseToHSVA } from './color.js';
...
const MarketColorPickerGradient$1 = /*@__PURE__*/ proxyCustomElement(class MarketColorPickerGradient extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-color-picker-gradient"];
    components.forEach(tagName => { switch (tagName) {
        case "market-color-picker-gradient":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketColorPickerGradient$1);
            }
            break;
    } });
}

const MarketColorPickerGradient = MarketColorPickerGradient$1;
const defineCustomElement = defineCustomElement$1;

export { MarketColorPickerGradient, defineCustomElement };
