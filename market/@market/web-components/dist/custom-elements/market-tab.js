...
const MarketTab$1 = /*@__PURE__*/ proxyCustomElement(class MarketTab extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-tab"];
    components.forEach(tagName => { switch (tagName) {
        case "market-tab":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTab$1);
            }
            break;
    } });
}

const MarketTab = MarketTab$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTab, defineCustomElement };
