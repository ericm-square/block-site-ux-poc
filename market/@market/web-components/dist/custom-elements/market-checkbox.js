...
const MarketCheckbox$1 = /*@__PURE__*/ proxyCustomElement(class MarketCheckbox extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-checkbox"];
    components.forEach(tagName => { switch (tagName) {
        case "market-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketCheckbox$1);
            }
            break;
    } });
}

const MarketCheckbox = MarketCheckbox$1;
const defineCustomElement = defineCustomElement$1;

export { MarketCheckbox, defineCustomElement };
