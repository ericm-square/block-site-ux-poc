...
const MarketIcon$1 = /*@__PURE__*/ proxyCustomElement(class MarketIcon extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "market-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketIcon$1);
            }
            break;
    } });
}

const MarketIcon = MarketIcon$1;
const defineCustomElement = defineCustomElement$1;

export { MarketIcon, defineCustomElement };
