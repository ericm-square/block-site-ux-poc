...
const MarketFileUpload$1 = /*@__PURE__*/ proxyCustomElement(class MarketFileUpload extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-file-upload"];
    components.forEach(tagName => { switch (tagName) {
        case "market-file-upload":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketFileUpload$1);
            }
            break;
    } });
}

const MarketFileUpload = MarketFileUpload$1;
const defineCustomElement = defineCustomElement$1;

export { MarketFileUpload, defineCustomElement };
