...
const MarketBanner$1 = /*@__PURE__*/ proxyCustomElement(class MarketBanner extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-banner"];
    components.forEach(tagName => { switch (tagName) {
        case "market-banner":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketBanner$1);
            }
            break;
    } });
}

const MarketBanner = MarketBanner$1;
const defineCustomElement = defineCustomElement$1;

export { MarketBanner, defineCustomElement };
