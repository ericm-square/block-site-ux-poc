...
const MarketInputPassword$1 = /*@__PURE__*/ proxyCustomElement(class MarketInputPassword extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-input-password"];
    components.forEach(tagName => { switch (tagName) {
        case "market-input-password":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketInputPassword$1);
            }
            break;
    } });
}

const MarketInputPassword = MarketInputPassword$1;
const defineCustomElement = defineCustomElement$1;

export { MarketInputPassword, defineCustomElement };
