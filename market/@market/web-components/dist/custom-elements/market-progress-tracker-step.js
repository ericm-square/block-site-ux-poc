...
const MarketProgressTrackerStep$1 = /*@__PURE__*/ proxyCustomElement(class MarketProgressTrackerStep extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-progress-tracker-step", {
        "active": [516],
        "compact": [516],
        "connector": [513],
        "completed": [516],
...
function defineCustomElement$1() {
    ...
    const components = ["market-progress-tracker-step"];
    components.forEach(tagName => { switch (tagName) {
        case "market-progress-tracker-step":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketProgressTrackerStep$1);
            }
            break;
    } });
}

const MarketProgressTrackerStep = MarketProgressTrackerStep$1;
const defineCustomElement = defineCustomElement$1;

export { MarketProgressTrackerStep, defineCustomElement };
