...
const MarketHeader$1 = /*@__PURE__*/ proxyCustomElement(class MarketHeader extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    renderDefaultNavigation() {
        ...
        return (h(MarketButtonTagName, { rank: "secondary", slot: "navigation", "aria-label": this.closeButtonAriaLabel, disabled: this.disableCloseButton, onClick: (event) => this.handleCloseButtonClick(event) }, h(MarketIconTagName, { slot: "icon", name: cjs.HEADER_CLOSE_BUTTON_ICON_ASSET })));
    }
    render() {
...
function defineCustomElement$1() {
    ...
    const components = ["market-header"];
    components.forEach(tagName => { switch (tagName) {
        case "market-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketHeader$1);
            }
            break;
    } });
}

const MarketHeader = MarketHeader$1;
const defineCustomElement = defineCustomElement$1;

export { MarketHeader, defineCustomElement };
