...
import { i as isValueEmpty } from './utils2.js';
...
const MarketFilterDropdownMenu$1 = /*@__PURE__*/ proxyCustomElement(class MarketFilterDropdownMenu extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-filter-dropdown-menu", {
        "size": [513],
        "filtersWithSelectedValue": [32],
        "hasSelectedFilter": [32],
        "isDropdownActive": [32]
    }, [[0, "marketDropdownOpened", "handleDropdownOpened"], [0, "marketDropdownClosed", "handleDropdownClosed"], [0, "marketHeaderNavigate", "handleHeaderNavigate"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["market-filter-dropdown-menu"];
    components.forEach(tagName => { switch (tagName) {
        case "market-filter-dropdown-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketFilterDropdownMenu$1);
            }
            break;
    } });
}

const MarketFilterDropdownMenu = MarketFilterDropdownMenu$1;
const defineCustomElement = defineCustomElement$1;

export { MarketFilterDropdownMenu, defineCustomElement };
