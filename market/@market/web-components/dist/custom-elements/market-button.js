...
const MarketButton$1 = /*@__PURE__*/ proxyCustomElement(class MarketButton extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-button"];
    components.forEach(tagName => { switch (tagName) {
        case "market-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketButton$1);
            }
            break;
    } });
}

const MarketButton = MarketButton$1;
const defineCustomElement = defineCustomElement$1;

export { MarketButton, defineCustomElement };
