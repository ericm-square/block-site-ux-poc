...
const MarketTableRow$1 = /*@__PURE__*/ proxyCustomElement(class MarketTableRow extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return MarketTableRowStyle0; }
        ...
        "toggleNestedRow": [64]
    }, [[0, "marketCheckboxValueChange", "handleMarketCheckboxValueChange"], [0, "marketToggleChange", "handleMarketCheckboxValueChange"]], {
        "gridTemplateMain": ["formNewGridTemplate"],
        "gridTemplateLeft": ["formNewGridTemplate"],
        "gridTemplateRight": ["formNewGridTemplate"],
        "gridTemplate": ["gridTemplateObserver"],
...
function defineCustomElement$1() {
    ...
    const components = ["market-table-row"];
    components.forEach(tagName => { switch (tagName) {
        case "market-table-row":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTableRow$1);
            }
            break;
    } });
}

const MarketTableRow = MarketTableRow$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTableRow, defineCustomElement };
