...
const MarketChoiceButton$1 = /*@__PURE__*/ proxyCustomElement(class MarketChoiceButton extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-choice-button"];
    components.forEach(tagName => { switch (tagName) {
        case "market-choice-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketChoiceButton$1);
            }
            break;
    } });
}

const MarketChoiceButton = MarketChoiceButton$1;
const defineCustomElement = defineCustomElement$1;

export { MarketChoiceButton, defineCustomElement };
