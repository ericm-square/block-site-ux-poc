...
const MarketCodeInput$1 = /*@__PURE__*/ proxyCustomElement(class MarketCodeInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-code-input"];
    components.forEach(tagName => { switch (tagName) {
        case "market-code-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketCodeInput$1);
            }
            break;
    } });
}

const MarketCodeInput = MarketCodeInput$1;
const defineCustomElement = defineCustomElement$1;

export { MarketCodeInput, defineCustomElement };
