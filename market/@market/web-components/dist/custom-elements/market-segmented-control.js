...
const MarketSegmentedControl$1 = /*@__PURE__*/ proxyCustomElement(class MarketSegmentedControl extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-segmented-control", {
        "value": [1537],
        "disabled": [516],
        "items": [32]
    }, [[0, "marketSegmentSelectedChanged", "marketSegmentSelectedEventHandler"]], {
        "value": ["valueWatcher"],
        "disabled": ["disabledChangeHandler"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["market-segmented-control"];
    components.forEach(tagName => { switch (tagName) {
        case "market-segmented-control":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketSegmentedControl$1);
            }
            break;
    } });
}

const MarketSegmentedControl = MarketSegmentedControl$1;
const defineCustomElement = defineCustomElement$1;

export { MarketSegmentedControl, defineCustomElement };
