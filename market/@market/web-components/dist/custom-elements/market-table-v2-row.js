...
const MarketTableV2Row$1 = /*@__PURE__*/ proxyCustomElement(class MarketTableV2Row extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return MarketTableV2RowStyle0; }
        ...
        "valign": [513],
        "setSelected": [64]
    }, [[0, "keydown", "onKeydown"], [0, "marketInternalTableV2CellSelectionChange", "onMarketInternalTableV2CellSelectionChange"]], {
        "caret": ["watchCaret"],
        "indent": ["watchIndent"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["market-table-v2-row"];
    components.forEach(tagName => { switch (tagName) {
        case "market-table-v2-row":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTableV2Row$1);
            }
            break;
    } });
}

const MarketTableV2Row = MarketTableV2Row$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTableV2Row, defineCustomElement };
