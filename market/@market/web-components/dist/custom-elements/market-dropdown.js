...
const MarketDropdown$1 = /*@__PURE__*/ proxyCustomElement(class MarketDropdown extends HTMLElement$1 {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-dropdown"];
    components.forEach(tagName => { switch (tagName) {
        case "market-dropdown":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketDropdown$1);
            }
            break;
    } });
}

const MarketDropdown = MarketDropdown$1;
const defineCustomElement = defineCustomElement$1;

export { MarketDropdown, defineCustomElement };
