...
const MarketFilterButton$1 = /*@__PURE__*/ proxyCustomElement(class MarketFilterButton extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-filter-button"];
    components.forEach(tagName => { switch (tagName) {
        case "market-filter-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketFilterButton$1);
            }
            break;
    } });
}

const MarketFilterButton = MarketFilterButton$1;
const defineCustomElement = defineCustomElement$1;

export { MarketFilterButton, defineCustomElement };
