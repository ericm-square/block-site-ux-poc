...
const MarketModalPartial$1 = /*@__PURE__*/ proxyCustomElement(class MarketModalPartial extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-modal-partial"];
    components.forEach(tagName => { switch (tagName) {
        case "market-modal-partial":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketModalPartial$1);
            }
            break;
    } });
}

const MarketModalPartial = MarketModalPartial$1;
const defineCustomElement = defineCustomElement$1;

export { MarketModalPartial, defineCustomElement };
