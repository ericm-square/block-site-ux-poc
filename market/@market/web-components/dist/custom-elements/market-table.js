...
const MarketTable$1 = /*@__PURE__*/ proxyCustomElement(class MarketTable extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-table"];
    components.forEach(tagName => { switch (tagName) {
        case "market-table":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTable$1);
            }
            break;
    } });
}

const MarketTable = MarketTable$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTable, defineCustomElement };
