...
import { i as isDraggable, D as Draggable } from './draggable.js';
...
const MarketTableV2Group$1 = /*@__PURE__*/ proxyCustomElement(class MarketTableV2Group extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-table-v2-group"];
    components.forEach(tagName => { switch (tagName) {
        case "market-table-v2-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTableV2Group$1);
            }
            break;
    } });
}

const MarketTableV2Group = MarketTableV2Group$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTableV2Group, defineCustomElement };
