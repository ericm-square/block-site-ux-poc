...
import { D as Draggable } from './draggable.js';
import { g as getNamespacedTagFor } from './index2.js';
import { a as asyncRequestAnimationFrame } from './raf.js';
import { a as isCheckboxElement, b as isRadioElement, c as isToggleElement } from './element-type-guard.js';
import { i as isArrayLike, a as isBuffer, b as isTypedArray, g as getTag, c as isPrototype, d as baseKeys } from './_getTag.js';
...
const MarketRow$1 = /*@__PURE__*/ proxyCustomElement(class MarketRow extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-row"];
    components.forEach(tagName => { switch (tagName) {
        case "market-row":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketRow$1);
            }
            break;
    } });
}

const MarketRow = MarketRow$1;
const defineCustomElement = defineCustomElement$1;

export { MarketRow, defineCustomElement };
