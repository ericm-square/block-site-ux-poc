...
const MarketEmptyState$1 = /*@__PURE__*/ proxyCustomElement(class MarketEmptyState extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-empty-state"]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["market-empty-state"];
    components.forEach(tagName => { switch (tagName) {
        case "market-empty-state":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketEmptyState$1);
            }
            break;
    } });
}

const MarketEmptyState = MarketEmptyState$1;
const defineCustomElement = defineCustomElement$1;

export { MarketEmptyState, defineCustomElement };
