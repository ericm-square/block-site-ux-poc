...
import { a as toNumber, t as throttle } from './throttle.js';
import { i as identity } from './identity.js';
import { s as setToString, o as overRest } from './_overRest.js';
...
const MarketSheet$1 = /*@__PURE__*/ proxyCustomElement(class MarketSheet extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-sheet"];
    components.forEach(tagName => { switch (tagName) {
        case "market-sheet":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketSheet$1);
            }
            break;
    } });
}

const MarketSheet = MarketSheet$1;
const defineCustomElement = defineCustomElement$1;

export { MarketSheet, defineCustomElement };
