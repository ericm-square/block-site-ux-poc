...
const MarketPaginationNav$1 = /*@__PURE__*/ proxyCustomElement(class MarketPaginationNav extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
    ...
    }, [[0, "marketListSelectionsDidChange", "listSelectionEventHandler"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["market-pagination-nav"];
    components.forEach(tagName => { switch (tagName) {
        case "market-pagination-nav":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketPaginationNav$1);
            }
            break;
    } });
}

const MarketPaginationNav = MarketPaginationNav$1;
const defineCustomElement = defineCustomElement$1;

export { MarketPaginationNav, defineCustomElement };

//# sourceMappingURL=market-pagination-nav.js.map