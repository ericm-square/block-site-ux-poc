...
const MarketTableColumn$1 = /*@__PURE__*/ proxyCustomElement(class MarketTableColumn extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-table-column"];
    components.forEach(tagName => { switch (tagName) {
        case "market-table-column":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTableColumn$1);
            }
            break;
    } });
}

const MarketTableColumn = MarketTableColumn$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTableColumn, defineCustomElement };
