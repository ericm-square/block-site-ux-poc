...
const MarketQrcode$1 = /*@__PURE__*/ proxyCustomElement(class MarketQrcode extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-qrcode"];
    components.forEach(tagName => { switch (tagName) {
        case "market-qrcode":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketQrcode$1);
            }
            break;
    } });
}

const MarketQrcode = MarketQrcode$1;
const defineCustomElement = defineCustomElement$1;

export { MarketQrcode, defineCustomElement };
