...
const MarketFilterGroup$1 = /*@__PURE__*/ proxyCustomElement(class MarketFilterGroup extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-filter-group", {
        "maxVisibleFilters": [2, "max-visible-filters"],
        "_sortedFilterEls": [32]
    }, [[0, "marketInputSearchFocus", "marketInputSearchFocusHandler"], [0, "marketInternalInputSearchCompactAnimation", "marketInternalInputSearchCompactAnimationHandler"], [0, "marketDropdownOpened", "marketDropdownOpenedHandler"]], {
        "maxVisibleFilters": ["maxVisibleFiltersWatcher"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["market-filter-group"];
    components.forEach(tagName => { switch (tagName) {
        case "market-filter-group":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketFilterGroup$1);
            }
            break;
    } });
}

const MarketFilterGroup = MarketFilterGroup$1;
const defineCustomElement = defineCustomElement$1;

export { MarketFilterGroup, defineCustomElement };
