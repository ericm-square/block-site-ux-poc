...
const MarketFilter$1 = /*@__PURE__*/ proxyCustomElement(class MarketFilter extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    }, [[0, "marketListSelectionsDidChange", "handleListSelectionChange"], [0, "marketDateRangeChanged", "handleDateRangeChange"], [0, "marketDropdownOpened", "handleDropdownOpened"], [0, "marketDropdownClosed", "handleDropdownClosed"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["market-filter"];
    components.forEach(tagName => { switch (tagName) {
        case "market-filter":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketFilter$1);
            }
            break;
    } });
}

const MarketFilter = MarketFilter$1;
const defineCustomElement = defineCustomElement$1;

export { MarketFilter, defineCustomElement };
