...
import { p as parseToHSVA } from './color.js';
...
const MarketColorPickerInput$1 = /*@__PURE__*/ proxyCustomElement(class MarketColorPickerInput extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
}, [1, "market-color-picker-input", {
        "value": [1537]
    }, [[0, "marketInputValueChange", "inputValueChange"]]]);
function defineCustomElement$1() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["market-color-picker-input"];
    components.forEach(tagName => { switch (tagName) {
        case "market-color-picker-input":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketColorPickerInput$1);
            }
            break;
    } });
}

const MarketColorPickerInput = MarketColorPickerInput$1;
const defineCustomElement = defineCustomElement$1;

export { MarketColorPickerInput, defineCustomElement };
