...
const MarketTextarea$1 = /*@__PURE__*/ proxyCustomElement(class MarketTextarea extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-textarea"];
    components.forEach(tagName => { switch (tagName) {
        case "market-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketTextarea$1);
            }
            break;
    } });
}

const MarketTextarea = MarketTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { MarketTextarea, defineCustomElement };
