...
const MarketToggle$1 = /*@__PURE__*/ proxyCustomElement(class MarketToggle extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-toggle"];
    components.forEach(tagName => { switch (tagName) {
        case "market-toggle":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketToggle$1);
            }
            break;
    } });
}

const MarketToggle = MarketToggle$1;
const defineCustomElement = defineCustomElement$1;

export { MarketToggle, defineCustomElement };
