...
const MarketDragHandle$1 = /*@__PURE__*/ proxyCustomElement(class MarketDragHandle extends HTMLElement {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
function defineCustomElement$1() {
    ...
    const components = ["market-drag-handle"];
    components.forEach(tagName => { switch (tagName) {
        case "market-drag-handle":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, MarketDragHandle$1);
            }
            break;
    } });
}

const MarketDragHandle = MarketDragHandle$1;
const defineCustomElement = defineCustomElement$1;

export { MarketDragHandle, defineCustomElement };

//# sourceMappingURL=market-drag-handle.js.map