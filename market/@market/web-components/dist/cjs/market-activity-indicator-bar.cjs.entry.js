...
const MarketActivityIndicatorBar = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '2e9db0488c0dc203483e1e9e56e41959a8329b1d', class: "market-activity-indicator-bar", role: "progressbar", "aria-valuenow": value, "aria-valuemin": "0", "aria-valuemax": max, "aria-valuetext": `${percentComplete}%` }, index.h("progress", { key: '5dfd6befd05042fa11d9488f0f20ecd83cda9a5c', value: value, max: max }, index.h("div", { key: 'cb0711db187e63011f1c2d12c4297c470f131445', class: "progress-bar" }, index.h("span", { key: '164fa23663f68bb1058f457f57e878971709773a', style: { width: `${percentComplete}%` } })))));
    }
    get el() { return index.getElement(this); }
};
MarketActivityIndicatorBar.style = MarketActivityIndicatorBarStyle0;

exports.market_activity_indicator_bar = MarketActivityIndicatorBar;

//# sourceMappingURL=market-activity-indicator-bar.cjs.entry.js.map