...
const MarketBlade = class {
    constructor(hostRef) {
        ...
        this.animationDuration = index$1.cjs.CORE_ANIMATION_ENTER_TRANSITION_MODERATE_SPEED_DURATION;
    ...
    componentWillLoad() {
        const header = this.el.querySelector(index$2.getNamespacedTagFor('market-header'));
        if (header) {
    ...
    render() {
        return (index.h(index.Host, { key: '06712e57a83ac4e3a59ad347b7dd3ee64345849e', role: "dialog", class: classnames.classNames('market-blade', {
                'skip-animation': this.skipAnimation,
            }) }, index.h("slot", { key: '99deb622ccd2263d07aedda7146998984498b3e6' })));
    }
...
MarketBlade.style = MarketBladeStyle0;

exports.market_blade = MarketBlade;

//# sourceMappingURL=market-blade.cjs.entry.js.map