...
const InputText = class {
    constructor(hostRef) {
        ...
        this.marketInputValueChange = index.createEvent(this, "marketInputValueChange", 7);
        this.marketInputDidLoad = index.createEvent(this, "marketInputDidLoad", 7);
    ...
    componentWillLoad() {
        ...
        this.mutationObserver = aria.observeAriaAttributes(this.el, (ariaAttributes) => {
    ...
    render() {
        return (index.h(index.Host, { key: '2b00628499d159769decf60369dacf70e7f25e76', class: "market-input-text", onBlur: () => {
                this.focused = false;
            }, onClick: () => {
                this.setFocus();
            }, onFocus: () => {
            ...
            } }, index.h("slot", { key: '4e44ddfc5331ad822c1c23daddbcab7236e2e41f', name: "leading-accessory" }), index.h("div", { key: '04efd6df745a8d1d72b1dc06d0fbd9127a32a604', class: classnames.classNames('label-input-container', {
                'has-leading-accessory': this.hasLeadingAccessory,
                'has-trailing-accessory': this.hasTrailingAccessory,
            }) }, index.h("slot", { key: 'e03b88c83f61893431f963b2a38796b4687d5cde' }), index.h("slot", { key: '5d92ec605564a2a9f2b45510a5b1e68f0ede8ebc', name: "input", onSlotchange: () => this.registerSlottedInput() }, !this.slottedInput && (index.h("input", Object.assign({ key: 'a51c7a88872af608513d780e7798990d7f76d38c', part: "native-input", ref: (input) => (this.nativeInput = input), onInput: (e) => this.valueDidChange(e), onAnimationStart: (e) => this.handleAutofill(e) }, this.sharedProps))))), index.h("slot", { key: 'fe4dc406e24264c849b098ee7b439b84124717ff', name: "trailing-accessory" })));
    }
...
InputText.style = MarketInputTextStyle0;

exports.market_input_text = InputText;

//# sourceMappingURL=market-input-text.cjs.entry.js.map