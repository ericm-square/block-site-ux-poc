...
const maxZIndex = require('./max-z-index-536dd36e.js');
...
const MarketSelect = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketSelectValueDidChange = index.createEvent(this, "marketSelectValueDidChange", 7);
        this.marketSelectOpened = index.createEvent(this, "marketSelectOpened", 7);
        this.marketSelectClosed = index.createEvent(this, "marketSelectClosed", 7);
    ...
    getDisplayedSelectionRow() {
        return this.el.querySelector(`${index$1.getNamespacedTagFor('market-row')}[slot="displayed-selection"]`);
    }
    /**
    ...
    displaySelection(selectedRows = []) {
        ...
        if (selectedRows.length === 1) {
             ...
             */
            const multiselectDisplayRow = document.createElement(`${index$1.getNamespacedTagFor('market-row')}`);
    ...
    async openList() {
        ...
        Object.assign(this.popoverElement.style, {
            zIndex: `${maxZIndex.getMaxZIndex(container) + 1}`,
            visibility: 'hidden',
        });
    ...
    */
    ...
    handleTriggerClick(ev) {
        if (ev.target.tagName.toLowerCase() === index$1.getNamespacedTagFor('market-tooltip')) {
            return;
        }
        if (this.readonly || this.disabled) {
            return;
    ...
    initPopover() {
        this.popoverElement =
            this.popoverElement ||
                document.createElement(index$1.getNamespacedTagFor('market-popover'));
    ...
    initRows() {
        this.rows = this.list.querySelectorAll(`${index$1.getNamespacedTagFor('market-row')}`);
        this.rows.forEach((row) => {
            // Set an ID for the row if it doesn't have one (we need this for aria-activedescendant)
            if (!row.id) {
                row.id = `market-row-${v4.v4()}`;
            }
        });
    ...
    componentWillLoad() {
        ...
        this.popoverId = this.popoverId || `popover-${v4.v4()}`;
    }
    componentDidLoad() {
        this.initList();
        this.initRows();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '9dc67f571060f9c4d9fc02684f5a1e6a4aeaf1ab', class: "market-select", role: "combobox", "aria-label": aria.getTextInputAriaLabel(this.el), "aria-expanded": this.listIsActive.toString(), "aria-controls": this.popoverId, "aria-activedescendant": this.focusedRowIndex > -1 ? this.rows[this.focusedRowIndex].id : null, "aria-required": this.required.toString(), tabindex: tabindex, onClick: (e) => {
                this.handleTriggerClick(e);
            }, onFocus: () => {
                this.handleFocus();
            }, onKeyDown: (e) => {
                this.handleTriggerKeyDown(e);
            } }, index.h("slot", { key: '4b32c361f91a9e3ec8d602cf1f876008f5faca75', name: "leading-accessory", onSlotchange: () => this.registerSlottedAccessories() }), index.h("div", { key: '2f0a75e0c406f2b1e84c0c050505109f2f6707dc', class: classnames.classNames('label-input-container', {
                'has-leading-accessory': this.hasLeadingAccessory,
                'has-trailing-accessory': this.hasTrailingAccessory,
            }) }, index.h("slot", { key: '01e62bf7c3d22901f05ba0d050e5acb2a40fca34' }), index.h("slot", { key: '6e3f1047cda70d511eb140be503f536991002af0', name: "displayed-selection" }, index.h("div", { key: 'f82cb1204a14479df042296bcdf038a5050b10eb', class: "placeholder" }, this.placeholder))), index.h("slot", { key: 'c101691da11b4a75af72cafa91f42fc7bb8da3b1', name: "list" }), index.h("slot", { key: 'a156419f608e21bec5ea1d6075fc07f7638dfe96', name: "trailing-accessory", onSlotchange: () => this.registerSlottedAccessories() }), index.h("svg", { key: '7fa3d353a90501483e0e5adb804af1b51a1b5593', class: "caret", width: "14", height: "8", viewBox: "0 0 14 8", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '4e3ff52b7499db8f87bfae74ef7757378858891b', "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M7.70715 7.70711C7.31663 8.09763 6.68346 8.09763 6.29294 7.70711L0.29294 1.70711L1.70715 0.292892L7.00005 5.58579L12.2929 0.292893L13.7072 1.70711L7.70715 7.70711Z", fill: "black" }))));
    }
...
MarketSelect.style = MarketSelectStyle0;

exports.market_select = MarketSelect;

//# sourceMappingURL=market-select.cjs.entry.js.map