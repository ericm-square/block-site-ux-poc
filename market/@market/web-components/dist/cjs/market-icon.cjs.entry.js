...
const marketSVGSprite = `<svg id="market-icon-sprite"><defs/><symbol id="market-icon-chevron-down-fidelity-16" viewBox="0 0 16 16" data-fidelity="16" data-name="chevron-down" data-default-fidelity="true" data-tintable="true" data-width="16" data-height="16">
...
const MarketIconStyle0 = marketIconCss;

const marketIconSVGSpriteID = '#market-icon-sprite';
const MarketIcon = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h(index.Host, { key: 'c8e658a53c2c5af0b32b3f123b124df008f0b499', class: "market-icon", tintable: this.tintable, style: {
                '--icon-width': `${this.width}px`,
                '--icon-height': `${this.height}px`,
            } }, index.h("slot", { key: '573037cc01b84ffac5e425ac25d9422aca7ae7ab' })));
    }
    get el() { return index.getElement(this); }
};
MarketIcon.style = MarketIconStyle0;

exports.market_icon = MarketIcon;

//# sourceMappingURL=market-icon.cjs.entry.js.map