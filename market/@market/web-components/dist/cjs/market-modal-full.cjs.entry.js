...
const MarketModalFull = class {
    constructor(hostRef) {
        ...
        this.animationEnterDuration = index$1.cjs.MODAL_FULL_ANIMATION_ENTER_TRANSITION_DURATION;
        this.animationExitDuration = index$1.cjs.MODAL_FULL_ANIMATION_EXIT_TRANSITION_DURATION;
    }
    layoutWatcher() {
    ...
    headerNavigateEventHandler(event) {
        ...
        if (detail.action === 'close') {
            ...
            if (target.closest(dialog.getDialogSelector()) === this.el) {
                this.dismiss();
            }
        }
    }
    ...
    repositionHeader() {
        ...
        const slottedHeader = this.el.querySelector(index$2.getNamespacedTagFor('market-header'));
        if (slottedHeader) {
    ...
    componentWillLoad() {
        dialog.setupDialogCompactHandler(this.el);
    }
    ...
    render() {
        return (index.h(index.Host, { key: '53ab9cd6782b0337c4b49d8ed8547ff697737017', class: "market-modal-full", role: "dialog" }, index.h("slot", { key: '31f2fa16cdfca98bda559b3ae777a73120acbc38', onSlotchange: () => this.repositionHeader() })));
    }
...
MarketModalFull.style = MarketModalFullStyle0;

exports.market_modal_full = MarketModalFull;

//# sourceMappingURL=market-modal-full.cjs.entry.js.map