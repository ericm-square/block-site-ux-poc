...
const MarketTextarea = class {
    constructor(hostRef) {
        ...
        this.marketTextareaValueChange = index.createEvent(this, "marketTextareaValueChange", 7);
        ...
        this.focused = false;
        this.invalid = false;
        this.maxHeight = `${index$1.cjs.TEXTAREA_MAXIMUM_HEIGHT}px`;
    ...
    updateSharedPropsAndSyncSlottedTextarea() {
        ...
        this.sharedProps = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (this.name && { name: this.name })), (this.placeholder && { placeholder: this.placeholder })), (this.maxlength !== undefined && Number.parseInt(this.maxlength, 10) >= 0 && { maxlength: this.maxlength })), (this.value !== undefined && { value: this.value })), (this.readonly && { readonly: this.readonly })), (this.disabled && { disabled: this.disabled })), (this.autofocus && { autofocus: this.autofocus })), (this.inputmode && { inputmode: this.inputmode })), this.ariaAttributes), { 'aria-label': aria.getTextInputAriaLabel(this.el) });
    ...
    render() {
        return (index.h(index.Host, { key: 'd3eff93de852f0b1f33bf7da766488313b423d8c', class: "market-textarea", onBlur: () => {
                this.focused = false;
            }, onClick: () => {
                this.setFocus();
            }, onFocus: () => {
                this.setFocus();
            } }, index.h("div", { key: '5e7d80d8934e0b29295db282f9e8df4a8543ce74', class: "label-input-container", part: "container" }, index.h("slot", { key: '52a6e3cdb68cef92a0b56d85aca22a3309ff3ad2' }), index.h("slot", { key: '2cc037b3ea0a349a61182804b3e5ecde4b8e9242', name: "textarea", onSlotchange: () => this.registerSlottedTextarea() }, !this.slottedTextarea && (index.h("textarea", Object.assign({ key: 'ab1a6abef98069da1f03b8d8e424e9450573a785' }, this.ariaAttributes, { id: this.name, onInput: (e) => this.textareaValueDidChange(e) }, this.sharedProps)))))));
    }
...
exports.market_textarea = MarketTextarea;

//# sourceMappingURL=market-textarea.cjs.entry.js.map