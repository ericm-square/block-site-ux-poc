 ...
 */
function stackClear() {
  this.__data__ = new _arrayPush.ListCache;
  this.size = 0;
}
...
function stackSet(key, value) {
  var data = this.__data__;
  if (data instanceof _arrayPush.ListCache) {
    ...
    data = this.__data__ = new _arrayPush.MapCache(pairs);
  }
  data.set(key, value);
  this.size = data.size;
  return this;
...
function Stack(entries) {
  var data = this.__data__ = new _arrayPush.ListCache(entries);
  this.size = data.size;
}
...
function baseGetAllKeys(object, keysFunc, symbolsFunc) {
  ...
  return _Map.isArray(object) ? result : _arrayPush.arrayPush(result, symbolsFunc(object));
}
...
function SetCache(values) {
  ...
  this.__data__ = new _arrayPush.MapCache;
  while (++index < length) {
...
function equalByTag(object, other, tag, bitmask, customizer, equalFunc, stack) {
  switch (tag) {
    ...
    case numberTag:
      ...
      return _arrayPush.eq(+object, +other);
...
//# sourceMappingURL=_baseIsEqual-9956408d.js.map