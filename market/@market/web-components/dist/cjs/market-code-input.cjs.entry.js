...
const MarketCodeInput = class {
    constructor(hostRef) {
        ...
        this.marketCodeInputValueChange = index.createEvent(this, "marketCodeInputValueChange", 7);
        this.type = 'number';
        this.name = undefined;
        this.length = 4;
        this.focused = false;
    ...
    render() {
        const inputs = [];
        this._code.forEach((char, index$1) => {
            const tabindex = this._code[index$1 - 1] || index$1 === 0 ? null : -1;
            inputs.push(index.h("input", { required: true, type: this.type === 'password' ? 'password' : 'text', inputmode: this.type === 'number' ? 'numeric' : null, autocomplete: index$1 === 0 ? 'one-time-code' : null, value: char, maxlength: index$1 === this.length - 1 ? '1' : null, readOnly: this.readonly, disabled: this.disabled, placeholder: "\u25CF", tabindex: tabindex, onFocus: (e) => this.onFocus(e), onBlur: () => this.onBlur(), onInput: (e) => this.onInput(e), onKeyDown: (e) => this.onKeyDown(e), onKeyUp: (e) => this.onKeyUp(e) }));
        });
        return (index.h(index.Host, { key: 'c11c05f9414698bd9d8f87b3e98adc021b233f1c', class: "market-code-input", name: this.name, onClick: () => this.onHostClick() }, index.h("span", { key: 'd3b5a43bb80ee199628650c96e6f9b17cf8fee88', class: "code-input-container" }, inputs), index.h("slot", { key: '8f0aa799fa46d759e6015488a07a2f6bb7c64669', name: "trailing-accessory" })));
    }
...
exports.market_code_input = MarketCodeInput;

//# sourceMappingURL=market-code-input.cjs.entry.js.map