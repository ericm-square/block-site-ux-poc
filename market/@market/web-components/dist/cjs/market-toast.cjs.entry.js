...
const MarketToast = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketToastAutoDismissed = index.createEvent(this, "marketToastAutoDismissed", 7);
        this.marketToastManuallyDismissed = index.createEvent(this, "marketToastManuallyDismissed", 7);
        this.variant = 'info';
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'fdf10e65a44f11b6e9c7c2ad76562888a9142b39', class: "market-toast", role: "alert" }, index.h("div", { key: '7a5d3cdc63b1cb3f5cde06f0b94427aca548d7ad', class: "content" }, index.h("span", { key: 'e359a579c7a0d155a5547ce2bfb6c723dcfd936b', class: "icon-container" }, index.h(MarketIconTagName, { key: '4947d2fe92bb868612d02b19d4c29189d9a9065a', name: this.getVariantIcon() })), index.h("div", { key: '1a8fdb2cdd9abcf85ca03b2374ed4f1c22ef0075', class: "main" }, index.h("section", { key: 'fa3335da51befad1ab399425d1f2161e86998c74' }, index.h("slot", { key: 'ff628bab0db6dcbdb0469e00e86b78e756d67121' })), index.h("nav", { key: 'd7a1f6203f81a1e4988abc5149770cdea2841628', "aria-label": "toast-actions", class: this.showActionsNav ? '' : 'hidden' }, index.h("slot", { key: 'f3cf89137e0234b85a604939004ad36ffd0631d1', name: "action", onSlotchange: () => this.checkIfActionsArePresent() }))), index.h("nav", { key: '9e115d8b1035d6cbab8004babfb445bd3165b192', "aria-label": "dismiss-container", class: "dismiss-container" }, index.h("button", { key: 'e4d1d6b5cc356bc8938b2fcd857d19f425c2cc0f', type: "button", "aria-label": this.dismissButtonAriaLabel, onClick: () => this.handleManualDismiss() }, index.h(MarketIconTagName, { key: '222a7a53bf9e260aa975f2cd8c5119381e59a994', name: "close" })))), this.progress >= 0 && (index.h("progress-bar", { key: '2050f45b9e54927cbe415c90e99a13f85e142142', role: "progressbar", "aria-valuenow": progress, "aria-valuemin": "0", "aria-valuemax": "100", style: progressStyle }))));
    }
    get el() { return index.getElement(this); }
};
MarketToast.style = MarketToastStyle0;

exports.market_toast = MarketToast;

//# sourceMappingURL=market-toast.cjs.entry.js.map