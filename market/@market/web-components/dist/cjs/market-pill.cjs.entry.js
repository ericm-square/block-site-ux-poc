...
const MarketPill = class {
    ...
    renderIndicator() {
        ...
        return this.size === 'medium' ? (index.h(MarketAccessoryTag, null, index.h("svg", { width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, index.h("circle", { cx: "8", cy: "8", r: "5" })))) : (index.h(MarketAccessoryTag, null, index.h("svg", { width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, index.h("circle", { cx: "8", cy: "8", r: "4" }))));
    }
    render() {
        return (index.h(index.Host, { key: 'e96bb6d40d9226db752a3934a88d04b5c5aa0cac', class: "market-pill" }, index.h("slot", { key: 'b1116a3e6fe9360b141f98c69c376ec2aea519f8', name: "icon" }, this.indicator && this.renderIndicator()), index.h("slot", { key: '4b50c149d4029c6847887127815d6146ce32a380' })));
    }
};
MarketPill.style = MarketPillStyle0;

exports.market_pill = MarketPill;

//# sourceMappingURL=market-pill.cjs.entry.js.map