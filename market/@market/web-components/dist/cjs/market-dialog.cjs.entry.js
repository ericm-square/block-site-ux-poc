...
const MarketDialog = class {
    constructor(hostRef) {
        ...
        this.animationEnterDuration = index$1.cjs.MODAL_DIALOG_ANIMATION_ENTER_TRANSITION_DURATION;
        this.animationExitDuration = index$1.cjs.MODAL_DIALOG_ANIMATION_EXIT_TRANSITION_DURATION;
    }
    /**
    ...
    render() {
        const MarketActivityIndicatorTagName = index$2.getNamespacedTagFor('market-activity-indicator');
        return (index.h(index.Host, { key: '7da7425983b6355851687256e2dc66d205f316ed', class: "market-dialog", role: "dialog" }, this.isLoading && index.h(MarketActivityIndicatorTagName, { key: '474cdfa415c07cf3c9e0cff7a0d0584f4b837386' }), index.h("slot", { key: 'f26ca73aa2034db72a0c075051f89c7e95dcfeea', onSlotchange: this.handleSlotchange.bind(this) })));
    }
...
MarketDialog.style = MarketDialogStyle0;

exports.market_dialog = MarketDialog;

//# sourceMappingURL=market-dialog.cjs.entry.js.map