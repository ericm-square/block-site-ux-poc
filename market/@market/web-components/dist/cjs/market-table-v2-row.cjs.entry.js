...
const MarketTableV2Row = class {
    constructor(hostRef) {
        ...
        this.marketInternalTableV2RowSelectionChange = index.createEvent(this, "marketInternalTableV2RowSelectionChange", 7);
        this.marketTableV2RowSelectionChange = index.createEvent(this, "marketTableV2RowSelectionChange", 7);
        this.active = false;
    ...
    async initFirstCell() {
        ...
        const MarketTableV2CellTagName = index$1.getNamespacedTagFor('market-table-v2-cell');
    ...
    renderDragHandleCell() {
        ...
        const MarketTableV2CellTagName = index$1.getNamespacedTagFor('market-table-v2-cell');
        return (index.h(MarketTableV2CellTagName, { class: "drag-handle-cell" }, index.h(MarketDragHandleTagName, { part: "drag-handle" })));
    }
    render() {
        const { dragEnabled, dragHandlePosition } = this;
        return (index.h(index.Host, { key: '6adae61ab707d2a6d4a73dd244855cf75d91ddb9', role: "row", class: "market-table-v2-row", tabindex: this.getTabIndex(), onMarketDragHandleDragStart: (e) => this.onDragStart(e), onMarketDragHandleDragMove: (e) => this.onDragMove(e), onMarketDragHandleDragEnd: (e) => this.onDragEnd(e) }, dragEnabled && dragHandlePosition === 'leading' && this.renderDragHandleCell(), index.h("slot", { key: '734bcabee33118c8368a332e8de4287099f1d1fa', onSlotchange: () => this.initFirstCell() }), dragEnabled && dragHandlePosition !== 'leading' && this.renderDragHandleCell()));
    }
...
exports.market_table_v2_row = MarketTableV2Row;

//# sourceMappingURL=market-table-v2-row.cjs.entry.js.map