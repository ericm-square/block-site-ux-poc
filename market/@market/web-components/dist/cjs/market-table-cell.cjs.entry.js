...
const MarketTableCell = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketTableCellClicked = index.createEvent(this, "marketTableCellClicked", 7);
        this.align = false;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '1bb91d3a4d5fcf5d7a27b3fa9af90f548f5e5e68', class: "market-table-cell", role: "cell", align: align === 'right' && align, hidden: hidden, tabindex: interactive && !disabled ? '0' : null, onClick: () => this.handleClick(), onKeydown: (e) => this.handleKeydown(e) }, index.h("slot", { key: 'e97ec19689f887c5e25949a69c28c41d56fd0e84', name: "nested-row-indicator" }), index.h("slot", { key: 'b9c46c7522d68ee674fed3eb04195924215a78c9', name: "leading-accessory" }), index.h("slot", { key: '9a15f89b0c3b4bd2939fcf713872a08978193400' }), index.h("slot", { key: '8094c84e509ca8854f87d56d34268544090bee78', name: "trailing-accessory" })));
    }
    get el() { return index.getElement(this); }
};
MarketTableCell.style = MarketTableCellStyle0;

exports.market_table_cell = MarketTableCell;

//# sourceMappingURL=market-table-cell.cjs.entry.js.map