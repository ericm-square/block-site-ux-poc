...
const MarketRadio = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketRadioValueChange = index.createEvent(this, "marketRadioValueChange", 7);
        this.selected = false;
        this.disabled = false;
        this.invalid = false;
        this.focused = false;
    ...
    render() {
        return (index.h(index.Host, { key: 'e4bc0538b6c3c6fb1d384cf4f4e500f34d4e0fb3', class: "market-radio", onBlur: () => {
                this.setFocus(false);
            }, onClick: this.handleClick, onFocus: () => {
                this.setFocus();
            } }, index.h("input", { key: '5150cbff8f7852b9541a7078551f6e30436e28ce', ref: (el) => (this.innerInput = el), type: "radio", "aria-label": aria.getControlInputAriaLabel(this.el), checked: this.selected, disabled: this.disabled }), this.selected && (index.h("svg", { key: '0051115cef2bf8e95ec556ecc3a9b81d32fbf7db', width: "6", height: "6", viewBox: "0 0 6 6", xmlns: "http://www.w3.org/2000/svg" }, index.h("circle", { key: '9a8a954420a18075bfed037d82dfbb0467cb7823', cx: "3", cy: "3", r: "3" })))));
    }
    get el() { return index.getElement(this); }
};
MarketRadio.style = MarketRadioStyle0;

exports.market_radio = MarketRadio;

//# sourceMappingURL=market-radio.cjs.entry.js.map