...
const MarketTab = class {
    constructor(hostRef) {
        ...
        this.marketTabSelectedChanged = index.createEvent(this, "marketTabSelectedChanged", 7);
        this.disabled = false;
        this.size = 'medium';
        this.selected = false;
    }
    ...
    render() {
        return (index.h(index.Host, { key: '63c07a1172617ce4a15296229d059bc449de69cc', "aria-disabled": this.disabled.toString(), "aria-selected": this.selected.toString(), class: "market-tab", onClick: this.handleClick.bind(this), onKeydown: this.handleKeydown.bind(this), role: "tab", tabindex: "0" }, index.h("button", { key: 'be7240c4232ba41743c7274f2630563267055b5a', disabled: this.disabled, part: "button", ref: (el) => (this.buttonEl = el), tabindex: "-1" }, index.h("slot", { key: '8d4d35e1d14a52fb3e6d71805ab83eae31a83009' }))));
    }
...
exports.market_tab = MarketTab;

//# sourceMappingURL=market-tab.cjs.entry.js.map