...
const MarketTile = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketTileSelectedChanged = index.createEvent(this, "marketTileSelectedChanged", 7);
        this.marketTileRemoveClicked = index.createEvent(this, "marketTileRemoveClicked", 7);
    ...
    renderDefaultRemoveAction() {
        ...
        return (index.h("button", { class: "remove-button", disabled: disabled, onClick: handleRemoveActionClick.bind(this), onKeyUp: handleRemoveActionKeydown.bind(this) }, index.h("svg", { slot: "icon", width: "16", height: "16", viewBox: "0 0 16 16", fill: "var(--core-critical-text-color)", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { d: "M12.8318 7.3335V7.1685H12.6668H3.3335H3.1685V7.3335V8.66683V8.83183H3.3335H12.6668H12.8318V8.66683V7.3335Z", fill: "var(--core-critical-text-color)", stroke: "var(--core-critical-text-color)", "stroke-width": "0.33" }))));
    }
    handleKeydown(event) {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'd517f7cb075bd6646ca3490faf7d0eeb127ffa82', class: "market-tile", tabindex: tabindex, "aria-selected": selected.toString(), onClick: (e) => this.handleClick(e), onKeydown: (e) => this.handleKeydown(e) }, index.h("div", { key: '4e8acbe5ef8c493e5b7dcdab61fe78aeb46a3058', class: classnames.classNames('background-image', { 'has-slotted-media': hasSlottedMedia }) }, index.h("slot", { key: 'ef14bfbc08c9cb408f3f6c778599af3a00857413', onSlotchange: () => this.checkSlottedMedia(), name: "media" })), index.h("slot", { key: '6f138c2dd2c724ed94d783971d5e61e690f3b204', name: "leading-accessory" }), index.h("div", { key: 'eb504c07a85e0888d6dc9e3cf691b4497428d185', class: "trailing-accessory-container" }, showActions && index.h("slot", { key: '5ad694873bbaea565bb629f48101311c52e5d5b1', name: "actions" }, this.renderDefaultRemoveAction()), !showActions && hasIndicatorTextSlot && index.h("slot", { key: '2e4922b851b506583bad374382a86751f263d575', name: "indicator" })), index.h("div", { key: '0ac231a58c9f189f38740ab5d2a97ae06e82386e', class: "content" }, size !== 'small' && index.h("slot", { key: 'ae24177ef72c114e1801f9baa06b656139efa4c1', onSlotchange: () => this.adjustSlottedLabels(), name: "hint" }), index.h("slot", { key: 'b99fe24dd8cf51110ca3276777ff36c1a416046f', onSlotchange: () => this.adjustSlottedLabels(), name: "label" }), index.h("slot", { key: 'ae3e99ca54cdfcfd1e8e0feb48e276b2c131d037', onSlotchange: () => this.adjustSlottedLabels(), name: "subtext" }))));
    }
...
MarketTile.style = MarketTileStyle0;

exports.market_tile = MarketTile;

//# sourceMappingURL=market-tile.cjs.entry.js.map