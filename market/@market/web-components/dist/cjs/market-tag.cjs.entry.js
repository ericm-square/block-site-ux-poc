...
const MarketTag = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketTagDismissed = index.createEvent(this, "marketTagDismissed", 7);
        this.disabled = false;
        this.focused = false;
        this.size = 'small';
        this.hasIcon = false;
    ...
    render() {
        return (index.h(index.Host, { key: '9588fafee1306f4e8fd89988093e4fb13afe38a5', class: `market-tag ${this.hasIcon ? 'has-icon' : ''}`, onClick: () => {
                this.onFocus();
            }, onFocus: () => {
                this.onFocus();
            }, "aria-disabled": this.disabled }, index.h("span", { key: '1499efc8496c40be712260fdcd91d23715aec3ab', class: "icon" }, index.h("slot", { key: 'e96de4aeb44f76d18c76daad4e847a6df4a60b2c', name: "icon" })), index.h("slot", { key: '037db2c8139ae0286ad1aded9f7ac7b35855c21d' }), index.h("svg", { key: '49798505faaf489b65a409e3caaf213480555eba', class: "remove-indicator", width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg", onClick: (e) => this.handleDismissTagEvent(e) }, index.h("path", { key: '1b0443049e52349ed740a3afba862645f38a7745', d: "M4.4734 12.4734L8.00007 8.94002L11.5267 12.4734L12.4734 11.5267L8.94007 8.00002L12.4734 4.47335L11.5267 3.52669L8.00007 7.06002L4.4734 3.52669L3.52673 4.47335L7.06007 8.00002L3.52673 11.5267L4.4734 12.4734Z" }))));
    }
    get el() { return index.getElement(this); }
};
MarketTag.style = MarketTagStyle0;

exports.market_tag = MarketTag;

//# sourceMappingURL=market-tag.cjs.entry.js.map