...
const MarketFilter = class {
    constructor(hostRef) {
        ...
        this.marketFilterClosed = index.createEvent(this, "marketFilterClosed", 7);
        this.marketFilterOpened = index.createEvent(this, "marketFilterOpened", 7);
        this.marketFilterExpandedChanged = index.createEvent(this, "marketFilterExpandedChanged", 7);
        this.marketFilterValueDidChange = index.createEvent(this, "marketFilterValueDidChange", 7);
        this.name = undefined;
    ...
    handleDefaultSlotChange() {
        this.datePickerEl = this.el.querySelector(index$1.getNamespacedTagFor('market-date-picker'));
        this.listEl = this.el.querySelector(index$1.getNamespacedTagFor('market-list'));
        const autoId = `popover-${v4.v4()}`;
        if (this.datePickerEl) {
    ...
    initRowObservers() {
        ...
        const rows = this.el.querySelectorAll(`${index$1.getNamespacedTagFor('market-list')} ${index$1.getNamespacedTagFor('market-row')}`);
        rows.forEach((row) => {
    ...
    getTextContentOfRowWithValue(value) {
        const marketRowTag = index$1.getNamespacedTagFor('market-row');
    ...
    setDisplayValueFromDateEvent(e) {
        ...
        if (menuSelection === menu.MENU_SLOT_NAMES.CUSTOM) {
            this.selectedDisplayValue = this.formatDate(e.detail);
        }
        else if (menuSelection) {
            // get the textContent of the menu item
            const presetMenuTextContent = (_d = (_c = (_b = (_a = this.datePickerEl) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector(`${index$1.getNamespacedTagFor('market-date-picker-menu')} slot[name="${menuSelection}"]`)) === null || _c === void 0 ? void 0 : _c.textContent) === null || _d === void 0 ? void 0 : _d.trim();
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '232446ed830e3feb776c691d0c77a27a13730e07', class: "market-filter" }, index.h(MarketDropdownTagName, { key: 'eeb8a4bfe3a2d0a2c8ecf73787e0de2105137ca2', class: "dropdown", disabled: disabled, expanded: expanded, interaction: interaction, popoverPlacement: popoverPlacement, popoverStrategy: popoverStrategy }, index.h(MarketFilterButtonTagName, { key: '7f34007cbf900c11b76d70d4b8ca5a341b0c69b7', active: expanded, class: "filter-button", disabled: disabled, ref: (el) => (this.filterButtonEl = el), slot: "trigger", size: size, popoverId: popoverId }, index.h("slot", { key: 'd69a920b6ece024223e9b41f938ded48d7581cd9', name: "label" }), !utils.isValueEmpty(selectedDisplayValue) && (index.h("span", { key: 'b780be1b15399455522269be98a395af03f64c8b', slot: "feedback" }, index.h("slot", { key: '92193310039dd4006cb34d945403f2f62aca4349', name: "display-value" }, selectedDisplayValue)))), index.h(MarketPopoverTagName, { key: '8e1d32d1b6782be2fc9ddc3e09dec981adce7613', class: classnames.classNames({ 'date-popover': hasDatePicker }), slot: "popover", id: popoverId }, index.h("slot", { key: '41b3895ba903e29b90063a3085a60ab0aa16bb75', onSlotchange: handleDefaultSlotChange.bind(this) }), index.h("slot", { key: '08001b6b66a5bbc79e9e8c9ad51f285baa19ecd3', name: "list", onSlotchange: handleDefaultSlotChange.bind(this) })))));
    }
    get el() { return index.getElement(this); }
};
MarketFilter.style = MarketFilterStyle0;

exports.market_filter = MarketFilter;

//# sourceMappingURL=market-filter.cjs.entry.js.map