...
class Reorderable {
    ...
    isValidDrag(dragged, source, target) {
        ...
        if (!draggable.isDraggable(dragged))
            return false;
    ...
    dragMove(e) {
        ...
        if (draggable.isMarketTableV2Group(targetSibling)) {
            // special case for table groups; look at the parent row
            const parent = [...targetSibling.children].find((el) => draggable.isMarketTableV2Row(el) && el.slot === 'parent');
            ...
            if (targetSibling.collapsible && targetSibling.collapsed) {
                ...
                if (y < oneThird) {
                    ...
                    parent.after(cursor);
                    const children = [...targetSibling.children].filter((el) => (draggable.isMarketTableV2Row(el) || draggable.isMarketTableV2Group(el)) && !el.slot);
...
exports.Reorderable = Reorderable;

//# sourceMappingURL=reorderable-38b00206.js.map