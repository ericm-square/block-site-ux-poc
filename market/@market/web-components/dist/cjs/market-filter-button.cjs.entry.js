...
const MarketFilterButton = class {
    ...
    render() {
        return (index.h(index.Host, { key: '752fd8ad8a381d5f89cf0e177d11ba9bb4d74a2c', class: "market-filter-button" }, index.h("button", { key: '42ad2cc1f2f0ab15177812c029be00a2c76bbe04', "aria-disabled": this.disabled, disabled: this.disabled, ref: (el) => (this.buttonEl = el), "aria-expanded": this.active.toString(), "aria-controls": this.popoverId, type: "button" }, index.h("svg", { key: '2fe6ab99cf28e8502042eebd33466849206357d9', width: "18", height: "12", viewBox: "0 0 18 12", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'a083550a7a9e99b2d609adfc231104bff2dd89d1', "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M0 0H18V2H0V0ZM15 5H3V7H15V5ZM12 10H6V12H12V10Z" })), index.h("span", { key: '9220d6f2bfa3c6640773aae7b0b0e10fe3c0bf8f', class: "label" }, index.h("slot", { key: '78a1dff60c4b0cf87141a94ed4cbecdf62d9f213' })), index.h("slot", { key: '4e28fde3d40ce59ed21759070255a094ba42bf9d', name: "feedback" }))));
    }
...
exports.market_filter_button = MarketFilterButton;

//# sourceMappingURL=market-filter-button.cjs.entry.js.map