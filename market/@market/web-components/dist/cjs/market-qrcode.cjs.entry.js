...
const MarketQrcode = class {
    ...
    render() {
        ...
        const containerStyle = this.size !== undefined
            ...
            : null;
        return (index.h(index.Host, { key: '5045d27eb8bd396a873727da5ac09bdabb1dcde9', class: "market-qrcode", "aria-hidden": "true" }, index.h("div", { key: '661f296b07f7e0278fdeeab78fe6b734a05bcce4', innerHTML: encoder ? encoder.svg : '', style: containerStyle })));
    }
};
MarketQrcode.style = MarketQrcodeStyle0;

exports.market_qrcode = MarketQrcode;

//# sourceMappingURL=market-qrcode.cjs.entry.js.map