...
const MarketFilterDropdownMenu = class {
    ...
    createRowsFromFilters() {
        ...
        this.filterEls.forEach((filterEl) => {
            ...
            if (currentRowEl) {
                ...
                const newRowEl = document.createElement(index$1.getNamespacedTagFor('market-row'));
    ...
    calculateFiltersWithSelectedValue() {
        this.filtersWithSelectedValue = [...(this.filterEls || [])].reduce((count, filterEl) => {
            const list = filterEl.querySelector(index$1.getNamespacedTagFor('market-list'));
            if (!utils.isValueEmpty(list === null || list === void 0 ? void 0 : list.value)) {
                return count + 1;
            }
            const datePicker = filterEl.querySelector(index$1.getNamespacedTagFor('market-date-picker'));
    ...
    render() {
        ...
        const MarketHeaderTagName = index$1.getNamespacedTagFor('market-header');
        ...
        return (index.h(index.Host, { key: 'a0855f0de2eacc84c813febeb342ca93632969c4', class: classnames.classNames('market-filter-dropdown-menu', { 'show-options': hasSelectedFilter }) }, index.h(MarketDropdownTagName, { key: 'fff9d200c45bad3f954435486c01877af984c7aa', interaction: "persistent", popoverPlacement: "bottom-end" }, index.h(MarketFilterButtonTagName, { key: '704fa58e50c9d254387e0765ae0b5d07830255c1', active: isDropdownActive, iconOnly: true, size: size, slot: "trigger" }, filtersWithSelectedValue && index.h("span", { key: '62cc860fe5084000ed4effbb64faf1e78de6e613', slot: "feedback" }, filtersWithSelectedValue)), index.h(MarketPopoverTagName, { key: '5c8149b85ffcca282d261f21480af60940ac081d', class: "popover", slot: "popover" }, !hasSelectedFilter ? (index.h(MarketListTagName, { class: "filter-list", interactive: true }, index.h("slot", { name: "filter-rows" }))) : (index.h(index.Fragment, null, index.h(MarketHeaderTagName, { class: "selection-header" }, index.h(MarketButtonTagName, { rank: "secondary", size: "small", slot: "navigation" }, index.h(MarketAccessoryTagName, { slot: "icon" }, index.h("svg", { width: "24", height: "24", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M4.29289 11.293C3.90237 11.6835 3.90237 12.3167 4.29289 12.7072L11.2929 19.7072L12.7071 18.293L7.41421 13.0001L19 13.0001V11.0001L7.41421 11.0001L12.7071 5.70718L11.2929 4.29297L4.29289 11.293Z" })))), index.h("slot", { name: "filter-title" })), index.h("div", { class: "filter-options-container" }, index.h("slot", { name: "filter-options" })))))), index.h("div", { key: '8d07e768be4265b1dc9fddcb830ca9d788a3da80', class: "overflow-filters" }, index.h("slot", { key: '4e9b383b6a4b36fc5665fd072965bfcf86c194ac', name: "overflow-filters", onSlotchange: handleOverflowFiltersSlotChange.bind(this) }))));
    }
    get el() { return index.getElement(this); }
};
MarketFilterDropdownMenu.style = MarketFilterDropdownMenuStyle0;

exports.market_filter_dropdown_menu = MarketFilterDropdownMenu;

//# sourceMappingURL=market-filter-dropdown-menu.cjs.entry.js.map