...
const getDialogSelector = () => ALL_DIALOG_TYPES.map((type) => {
    return index.getNamespacedTagFor(`market-${type}`);
}).join(',');
function setupDialogCompactHandler(modal) {
    const main = modal.querySelector('main, .main');
    const header = modal.querySelector(index.getNamespacedTagFor('market-header'));
...
exports.ALL_DIALOG_TYPES = ALL_DIALOG_TYPES;
exports.DIALOGS_META = DIALOGS_META;
exports.getDialogSelector = getDialogSelector;
exports.setupDialogCompactHandler = setupDialogCompactHandler;

//# sourceMappingURL=dialog-3b638e9e.js.map