...
const MarketDragHandle = class {
    constructor(hostRef) {
        ...
        this.marketDragHandleDragStart = index.createEvent(this, "marketDragHandleDragStart", 7);
        this.marketDragHandleDragMove = index.createEvent(this, "marketDragHandleDragMove", 7);
        this.marketDragHandleDragEnd = index.createEvent(this, "marketDragHandleDragEnd", 7);
