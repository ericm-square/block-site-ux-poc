...
const MarketCheckbox = class {
    constructor(hostRef) {
        ...
        this.marketCheckboxValueChange = index.createEvent(this, "marketCheckboxValueChange", 7);
        this.checked = false;
        this.disabled = false;
    ...
    render() {
        return (index.h(index.Host, { key: '986021083a3fee4efb0f7f4c815ba933b8bc74be', class: "market-checkbox", onBlur: () => {
                this.setFocus(false);
            }, onClick: this.handleClick, onFocus: () => {
                this.setFocus();
            } }, index.h("input", { key: '6e48efe625e8a2bf41973d53494bc986bfabfc53', ref: (el) => (this.innerInput = el), type: "checkbox", "aria-label": aria.getControlInputAriaLabel(this.el), checked: this.checked, indeterminate: this.indeterminate, disabled: this.disabled }), this.checked && !this.indeterminate && (index.h("svg", { key: 'bb79e0d37686e6439c90f5cb1cf5cb8254f644bf', width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", "data-testid": "check" }, index.h("path", { key: 'a04b9d93b99f30815a97a3f0c63d9bbc14c1fd09', d: "M6 10L8.85714 13L14 7", stroke: "white", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" }))), this.indeterminate && (index.h("svg", { key: 'a3f4496a0b99ef3cd29ef3a631eb2aa0e57bcc21', width: "20", height: "20", viewBox: "0 0 20 20", fill: "none", xmlns: "http://www.w3.org/2000/svg", "data-testid": "indeterminate" }, index.h("path", { key: '2e3e2bd50a4f8ec1f10ad186b603463d20c73916', d: "M6 10H14", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" })))));
    }
    get el() { return index.getElement(this); }
};
MarketCheckbox.style = MarketCheckboxStyle0;

exports.market_checkbox = MarketCheckbox;

//# sourceMappingURL=market-checkbox.cjs.entry.js.map