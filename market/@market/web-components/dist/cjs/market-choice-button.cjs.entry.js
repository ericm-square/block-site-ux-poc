...
const MarketChoiceButton = class {
    constructor(hostRef) {
        ...
        this.marketChoiceButtonSelected = index.createEvent(this, "marketChoiceButtonSelected", 7);
        this.marketChoiceButtonDeselected = index.createEvent(this, "marketChoiceButtonDeselected", 7);
        this.disabled = false;
        this.selected = false;
        this.size = 'medium';
    }
    ...
    render() {
        const { disabled } = this;
        return (index.h(index.Host, { key: '5fed443777aa284760086db85df12d195aada3cc', class: "market-choice-button", tabindex: disabled ? -1 : undefined, onClick: (e) => {
                this.onClick(e);
            } }, index.h("button", { key: 'c8e8aff08358a621202d705f6aa63f9dbeb7ab37', "aria-disabled": disabled }, index.h("slot", { key: '032cec3910431ad73dffef0d7fae6dfb72a3a4e2' }), index.h("slot", { key: '1921baa2a22e9ef012979d7232ac4dee74353776', name: "secondary-text" }))));
    }
    get el() { return index.getElement(this); }
};
MarketChoiceButton.style = MarketChoiceButtonStyle0;

exports.market_choice_button = MarketChoiceButton;

//# sourceMappingURL=market-choice-button.cjs.entry.js.map