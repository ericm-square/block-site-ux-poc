...
const marketDropdownCss = ":host{display:inline-block}:host ::slotted([slot=\"trigger\"]){cursor:pointer !important;}:host ::slotted([slot=\"popover\"]){z-index:99999;opacity:0%;visibility:hidden;pointer-events:none}:host([expanded]) ::slotted([slot=\"popover\"]){opacity:100%;visibility:visible;pointer-events:auto}:host([expanded]) .🙃{visibility:hidden}@media (min-width: 600px){:host ::slotted(.market-popover){max-width:400px}}";
const MarketDropdownStyle0 = marketDropdownCss;

const MarketDropdown = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketDropdownOpened = index.createEvent(this, "marketDropdownOpened", 7);
        this.marketDropdownClosed = index.createEvent(this, "marketDropdownClosed", 7);
        /**
         * Popper instance
         */
    ...
    syncDisabledState() {
        ...
        const slottedTriggerElements = this.el.querySelectorAll(dropdown.supportedDropdownTriggers.map((elName) => index$1.getNamespacedTagFor(elName)).join(','));
    ...
    registerTrigger() {
        this.slottedTriggerEl = this.el.querySelector(dropdown.supportedDropdownTriggers.join(','));
    ...
    componentWillRender() {
        if (this.slottedTriggerEl) {
            ...
            if (!popover.id) {
                popover.id = `popover-${v4.v4()}`;
            }
            aria.applyExpandableAriaControls(this.slottedTriggerEl, {
    ...
    render() {
        return (index.h(index.Host, { key: '8f536e224e90a942948d1d8f1c2618e8c3c1d70d', class: "market-dropdown", expanded: this.expanded, onClick: (e) => {
                ...
                this.handleInteraction(e);
            } }, index.h("slot", { key: '70de16830a447a9ae2fb1b92f88d03a01a315b2e', name: "trigger", onSlotchange: () => this.registerTrigger() }), index.h("slot", { key: '027a7018a99e24b1fa18b484368752a892180d09', name: "popover", onSlotchange: () => this.initializePopper() })));
    }
...
MarketDropdown.style = MarketDropdownStyle0;

exports.market_dropdown = MarketDropdown;

//# sourceMappingURL=market-dropdown.cjs.entry.js.map