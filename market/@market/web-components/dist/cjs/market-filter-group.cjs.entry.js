...
const MarketFilterGroup = class {
    constructor(hostRef) {
         ...
         */
        this._observers = {};
        this.throttledHandleResize = throttle.throttle(this.handleResize.bind(this), RESIZE_DEBOUNCE_DURATION);
    ...
    marketDropdownOpenedHandler(e) {
        ...
        setTimeout(async () => {
            ...
            await raf.asyncRequestAnimationFrame();
            await ((_c = (_b = (_a = this._dropdownMenuEl) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector(index$1.getNamespacedTagFor('market-dropdown'))) === null || _c === void 0 ? void 0 : _c.updateDropdownPosition());
            (_f = (_e = (_d = this._dropdownMenuEl) === null || _d === void 0 ? void 0 : _d.shadowRoot) === null || _e === void 0 ? void 0 : _e.querySelector(index$1.getNamespacedTagFor('market-dropdown'))) === null || _f === void 0 ? void 0 : _f.openDropdown();
        }, index$2.cjs.CORE_ANIMATION_EXIT_TRANSITION_FAST_SPEED_DURATION * 1.25);
    }
    /**
    ...
    calculateOverflowButtonWidth(filterEls) {
        ...
        const hasValueCount = filterEls.reduce((result, filterEl) => {
            const listEl = filterEl.querySelector(index$1.getNamespacedTagFor('market-list'));
            if (listEl === null || listEl === void 0 ? void 0 : listEl.value) {
                return result + 1;
            }
            const datePickerEl = filterEl.querySelector(index$1.getNamespacedTagFor('market-date-picker'));
        ...
        if (filterEls[0].size === 'small') {
            context.font = `${index$2.cjs.CORE_TYPE_PARAGRAPH_20_SIZE}px ${index$2.cjs.CORE_TYPE_PARAGRAPH_20_FONT_FAMILY}`;
        }
        else {
            context.font = `${index$2.cjs.CORE_TYPE_PARAGRAPH_30_SIZE}px ${index$2.cjs.CORE_TYPE_PARAGRAPH_30_FONT_FAMILY}`;
        }
    ...
    async findFilterCutoffIndex() {
        ...
        const isNarrowBreakpoint = (window === null || window === void 0 ? void 0 : window.innerWidth) <= index$2.cjs.CORE_BREAKPOINT_NARROW_MAX_WIDTH;
    ...
    async handleResize() {
        ...
        if (isFilterCutoffUpdated) {
            ...
            if (this._dropdownMenuEl) {
                const dropdownEl = this._dropdownMenuEl.querySelector(index$1.getNamespacedTagFor('market-dropdown'));
    ...
    handleInputSearchFocus() {
        var _a, _b;
        const dropdownEl = (_b = (_a = this._dropdownMenuEl) === null || _a === void 0 ? void 0 : _a.shadowRoot) === null || _b === void 0 ? void 0 : _b.querySelector(index$1.getNamespacedTagFor('market-dropdown'));
    ...
    registerSlottedFilters() {
        this._filterEls = [...this.el.children].filter((el) => index$1.isElementWithTagName(el, 'market-filter'));
    }
    observeContent(el) {
    ...
    render() {
        ...
        const MarketFilterDropdownMenuTagName = index$1.getNamespacedTagFor('market-filter-dropdown-menu');
        return (index.h(index.Host, { key: 'bcebdf2c66d61a3bdf5b7e68b049ae8aef8d592b', class: "market-filter-group" }, index.h("div", { key: '54f3edb35faf0ebabc85d5564f15d144aa8405d2', class: "content", ref: (el) => this.observeContent(el) }, index.h("slot", { key: '0f0f1052cf9714fbf3dd9d134fb509979bd8f03a', name: "search", onSlotchange: () => this.registerSlottedInputSearch() }), index.h("slot", { key: '30813cd9185d3cf5728e7fe20e90e3cda4bb3388', name: "filters", onSlotchange: () => this.filtersOnSlotChangeHandler() }), this._sortedFilterEls.overflow.length > 0 && (index.h(MarketFilterDropdownMenuTagName, { key: '7db61ce101fcd40d802ccfb58f238c61312b857a', class: "dropdown-menu", size: dropdownMenuButtonSize, ref: (el) => (this._dropdownMenuEl = el) }, index.h("slot", { key: '6f0d43ea458edc1181a046ab7d261aabd4f0b5f8', name: "overflow-filters", slot: "overflow-filters" }))))));
    }
...
exports.market_filter_group = MarketFilterGroup;

//# sourceMappingURL=market-filter-group.cjs.entry.js.map