...
const MarketButtonGroup = class {
    ...
    async findButtonCutoffIndex() {
        ...
        for (const buttonEl of this._buttonEls) {
            ...
            const dropdownMenuButtonWidth = index + 1 === this._buttonEls.length // is this the last one?
                ? 0
                : index$2.cjs.BUTTON_GROUP_SPACING + DROPDOWN_MENU_BUTTON_WIDTH;
            ...
            buttonWidths += (index > 0 ? index$2.cjs.BUTTON_GROUP_SPACING : 0) + buttonElWidth;
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '0057bde7c5189dc71782960ea6a0a05ab850ffae', class: "market-button-group" }, index.h("div", { key: 'bb2bae68c3f6bcce4a467153493c54e5bf74a8d8', class: "content", ref: (el) => this.observeContent(el) }, index.h("slot", { key: 'aa97b649151b3dae1d6f98b07b55ebd5b59124a8', onSlotchange: () => this.registerSlottedButtons() }), this._sortedButtonEls.overflow.length > 0 && (index.h(MarketButtonDropdownTagName, { key: 'ed1403f69d8bdf9a2b177ab7d16274e78cd1c3bf', "no-caret": true, "popover-strategy": this.popoverStrategy }, index.h(MarketButtonTagName, { key: '633ade9faa3248a77fe539d03c3593778ce2647f', slot: "trigger" }, index.h(MarketIconTagName, { key: '61a4cf7a55a68750d827d9950232a564e1664150', slot: "icon", name: index$2.cjs.BUTTON_GROUP_OVERFLOW_BUTTON_ICON_ASSET })), index.h("div", { key: '1e30bc26ee0d90bbd1ca0324d7054d74beea088e', slot: "content" }, index.h("slot", { key: 'f02cea12d210b2170d13c14a10ac8027360cc445', name: "overflow-buttons", slot: "overflow-buttons" })))))));
    }
    get el() { return index.getElement(this); }
};
MarketButtonGroup.style = MarketButtonGroupStyle0;

exports.market_button_group = MarketButtonGroup;

//# sourceMappingURL=market-button-group.cjs.entry.js.map