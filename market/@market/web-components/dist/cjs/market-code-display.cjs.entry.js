...
const MarketCodeDisplay = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketCodeCopied = index.createEvent(this, "marketCodeCopied", 7);
        /**
    ...
    initCodeChars(code) {
        ...
        const BLANK_CODE_SPAN = index.h("span", { class: "code-char" });
        ...
        if (codeLen !== CODE_GROUP_LEN && codeLen % CODE_GROUP_LEN === 0) {
            for (let i = 0; i < codeLen; i++) {
                ...
                this.codeChars.push(index.h("span", { class: "code-char" }, code[i]));
            }
        }
    ...
    render() {
        return (index.h(index.Host, { key: 'd20b66bb6de60a11d86a92b2fa8faafa594727b7', class: "market-code-display", tabIndex: this.disabled ? null : 0, "aria-label": this.code }, index.h("span", { key: 'd403656bd834ecea1b9deb6409d9d0747e41e27b', class: "code-container" }, this.codeChars), index.h("span", { key: '87a4cc31d2bcf6dd393b247e43a75067cd65b0e0', class: "actions-container" }, index.h("slot", { key: '42ceb91d39adfef778a695c1c4b3700d78d77a55', name: "actions" }))));
    }
    get el() { return index.getElement(this); }
};
MarketCodeDisplay.style = MarketCodeDisplayStyle0;

exports.market_code_display = MarketCodeDisplay;

//# sourceMappingURL=market-code-display.cjs.entry.js.map