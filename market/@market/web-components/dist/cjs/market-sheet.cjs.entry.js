...
const focusTrap = require('./focus-trap-704bcbe5.js');
...
var delay = baseRest(function(func, wait, args) {
  return baseDelay(func, throttle.toNumber(wait) || 0, args);
});
...
const TOP_GAP = index$1.cjs.MODAL_SHEET_HANDLE_HEIGHT + index$1.cjs.MODAL_SHEET_HANDLE_PADDING_BOTTOM_SIZE + index$1.cjs.MODAL_SHEET_HANDLE_PADDING_TOP_SIZE;
...
const MarketSheet = class {
    constructor(hostRef) {
        ...
        this.marketDialogLoaded = index.createEvent(this, "marketDialogLoaded", 7);
        this.marketDialogDismissed = index.createEvent(this, "marketDialogDismissed", 7);
        this.marketDialogDidDismiss = index.createEvent(this, "marketDialogDidDismiss", 7);
        this.type = 'sheet';
    ...
    async activateFocusTrap(options, activateOptions) {
        if (this.focusTrap) {
            ...
            this.focusTrap = focusTrap.createAndActivateFocusTrap({
                activateOptions,
                el: this.el,
    ...
    async dismiss(options) {
        ...
        if (!defaultPrevented) {
            this.hidden = true;
            await new Promise((resolve) => setTimeout(resolve, index$1.cjs.CORE_ANIMATION_EXIT_TRANSITION_MODERATE_SPEED_DURATION));
    ...
    onDragStart(e) {
        ...
        const eventCoords = utils.getCoordsFromEvent(e);
    ...
    onScrollDrag(e) {
        ...
        const dragCoords = utils.getCoordsFromEvent(e);
    ...
    connectedCallback() {
        ...
        }, this.hidden ? 0 : index$1.cjs.CORE_ANIMATION_ENTER_TRANSITION_MODERATE_SPEED_DURATION);
    }
    hiddenHandler() {
    ...
    componentDidLoad() {
        ...
        this.heightObserver = new ResizeObserver(throttle.throttle(() => {
            this.resetTopByState();
        ...
        window.visualViewport.addEventListener('resize', throttle.throttle(() => {
            this.resetTopByState();
        }, RESIZE_DEBOUNCE_DURATION));
    ...
    render() {
        return (index.h(index.Host, { key: '0141e61e23a2b16ef9768c130296e7664c99ddcd', role: "dialog", onMouseDown: (e) => this.onDragStart(e), onTouchStart: (e) => this.onDragStart(e) }, index.h("button", { key: '08b465eb785a4f2055d448f3db5b062228458f40', "aria-label": this.closeHandleAriaLabel, class: "handle", onClick: this.dismiss.bind(this), onKeyDown: this.onKeyDown.bind(this) }), index.h("slot", { key: '7d87505923bbd66b5c0ee95c4c8f79f544fda8f6', name: "header" }), index.h("div", { key: 'c643d8f2e58a18035ca76cbc034bd50922114fe9', class: "main", ref: (el) => (this.mainContent = el), onTouchStart: () => this.onScrollStart() }, index.h("slot", { key: 'ce2087b1d85f22c5b2edc78b8f6cf9dd687a54e3' }))));
    }
...
exports.market_sheet = MarketSheet;

//# sourceMappingURL=market-sheet.cjs.entry.js.map