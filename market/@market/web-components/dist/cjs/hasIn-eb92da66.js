...
const isSymbol = require('./isSymbol-fbd13c73.js');
...
function memoize(func, resolver) {
  ...
  memoized.cache = new (memoize.Cache || _arrayPush.MapCache);
  return memoized;
}

// Expose `MapCache`.
memoize.Cache = _arrayPush.MapCache;
...
function hasPath(object, path, hasFunc) {
  ...
  return !!length && _Map.isLength(length) && _arrayPush.isIndex(key, length) &&
    (_Map.isArray(object) || _Map.isArguments(object));
}
...
//# sourceMappingURL=hasIn-eb92da66.js.map