...
const MarketTableRow = class {
    constructor(hostRef) {
        ...
        this.marketTableHeaderLoaded = index.createEvent(this, "marketTableHeaderLoaded", 7);
        this.marketTableRowClicked = index.createEvent(this, "marketTableRowClicked", 7);
        this.marketTableRowStick = index.createEvent(this, "marketTableRowStick", 7);
        this.marketTableRowUnstick = index.createEvent(this, "marketTableRowUnstick", 7);
        this.marketAccordionToggled = index.createEvent(this, "marketAccordionToggled", 7);
        this.marketNestedRowToggled = index.createEvent(this, "marketNestedRowToggled", 7);
    ...
    componentWillLoad() {
        ...
        // prettier-ignore
        this.cells = this.el.querySelectorAll(index$1.getNamespacedTagFor('market-table-cell'));
    }
    handleSlotChange() {
        this.cells = this.el.querySelectorAll(`${index$1.getNamespacedTagFor('market-table-cell')}, ${index$1.getNamespacedTagFor('market-table-column')}`);
        ...
        if (this.header) {
            this.marketTableHeaderLoaded.emit({
                columns: this.el.querySelectorAll(index$1.getNamespacedTagFor('market-table-column')),
            });
        }
        this.emitStickyEvents();
    }
    _getMarketRowElement(element) {
        return element.querySelector(index$1.getNamespacedTagFor('market-table-row'));
    }
    ...
    _registerSlottedControl() {
        this.slottedControl = this.el.querySelector([
            `[slot="control"] ${index$1.getNamespacedTagFor('market-checkbox')}`,
            `[slot="control"] ${index$1.getNamespacedTagFor('market-toggle')}`,
        ].join(','));
    ...
    componentDidRender() {
        ...
        const accordionElement = this.el.closest(index$1.getNamespacedTagFor('market-accordion-item'));
        if (accordionElement) {
            let parentRow;
            if (this.el.slot === 'custom-trigger') {
                // If current row has nested row, we need to look a level above for
                // the correct indentation.
                const parentAccordionElement = (_a = accordionElement.parentElement) === null || _a === void 0 ? void 0 : _a.closest(index$1.getNamespacedTagFor('market-accordion-item'));
    ...
    handleClick(e) {
        const ignoredElementTagNames = [
            index$1.getNamespacedTagFor('market-accessory'),
            index$1.getNamespacedTagFor('market-button'),
            index$1.getNamespacedTagFor('market-button-dropdown'),
            index$1.getNamespacedTagFor('market-checkbox'),
            index$1.getNamespacedTagFor('market-link'),
            index$1.getNamespacedTagFor('market-toggle'),
            'button',
            'a',
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'b21f7e4205a1bdeedb0e5b954cca59fa929759b6', "aria-selected": slottedControl ? Boolean(selected).toString() : null, class: "market-table-row", role: "row", tabindex: interactive && !disabled ? '0' : null, header: header, footer: footer, onClick: (e) => this.handleClick(e), onKeydown: (e) => this.handleKeydown(e) }, index.h(MarketTableAreaTagName, { key: '1ec156add1e9edfbc896c2bf4b4ed2dec6abc853', orientation: "vertical", "stick-to": "left", gridTemplate: gridTemplateLeft, ref: (el) => (this.tableAreaLeft = el) }, index.h("slot", { key: 'cc0b2f616a2ce5ee5cff172f71cfa061c5a19d39', name: "sticky-left" })), index.h(MarketTableAreaTagName, { key: '6c16c71570af888f249ed17e208cf7ba529ed408', orientation: "vertical", gridTemplate: gridTemplateMain, ref: (el) => (this.tableAreaMain = el), active: true }, index.h("slot", { key: '3fa9a13284967ade7ca15968a9be73b097c2934e', name: "control", onSlotchange: () => this._registerSlottedControl() }), index.h("slot", { key: '3ce80946bd17ff03315262bff77d728f92fc9fe0', onSlotchange: () => this.handleSlotChange() })), index.h(MarketTableAreaTagName, { key: '8c37a017089cc05a86be2228bdb56d3ce7da6d5b', orientation: "vertical", "stick-to": "right", gridTemplate: gridTemplateRight, ref: (el) => (this.tableAreaRight = el) }, index.h("slot", { key: '4144f5e42d7371d60733da1d8cc584a16f6d9eb0', name: "sticky-right" }))));
    }
...
exports.market_table_row = MarketTableRow;

//# sourceMappingURL=market-table-row.cjs.entry.js.map