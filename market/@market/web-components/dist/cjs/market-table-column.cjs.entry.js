...
const MarketTableColumn = class {
    constructor(hostRef) {
        ...
        this.marketTableColumnStick = index.createEvent(this, "marketTableColumnStick", 7);
        this.marketTableColumnUnstick = index.createEvent(this, "marketTableColumnUnstick", 7);
        this.marketTableColumnSort = index.createEvent(this, "marketTableColumnSort", 7);
        this.marketTableColumnVisibilityChange = index.createEvent(this, "marketTableColumnVisibilityChange", 7);
        this.name = undefined;
        this.align = false;
    ...
    render() {
        return (index.h(index.Host, { key: 'de01f70eb5bef7de63a4cd77fc72d01adadbc2b5', class: "market-table-column", align: this.align === 'right' && this.align, role: "columnheader", "aria-sort": this.sortOrder, onClick: () => this.clickHandler() }, index.h("slot", { key: 'cafa7ea4eb183281b723bd1acd4fcd6b1171bc43', name: "leading-accessory" }), this.sortable && (
        // A11Y: This button allows screen readers to access and click on the column header.
        index.h("button", { key: 'eda26a17db04b3fad4ff4d0fe288195a6eeccc9c' }, index.h("slot", { key: '37881dbd5b4e12c5b423ea9d0d0efc31b1de500a' }), index.h("svg", { key: '1e210d74d75f0122fae652a4733c5f4d556a5eb8', width: "16", height: "15", viewBox: "0 0 16 15", fill: "none", xmlns: "http://www.w3.org/2000/svg", class: "sorting-caret", "aria-hidden": "true" }, index.h("path", { key: '95c1ac04ae00a822fbc484cbf05ee68358937add', "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.70709 14.7071C8.31657 15.0976 7.6834 15.0976 7.29288 14.7071L0.292879 7.7071L1.70709 6.29289L6.99999 11.5858L6.99999 -7.612e-07L8.99999 -5.86354e-07L8.99999 11.5858L14.2929 6.29289L15.7071 7.70711L8.70709 14.7071Z" })))), !this.sortable && index.h("slot", { key: '56146bd9c9a751c9de482596423f5ff8e1f70484' }), index.h("slot", { key: 'a9c0f4ae4ccd08a29c76272ac4e9717a89744a5e', name: "trailing-accessory" })));
    }
...
exports.market_table_column = MarketTableColumn;

//# sourceMappingURL=market-table-column.cjs.entry.js.map