...
const MarketToggle = class {
    constructor(hostRef) {
        ...
        this.marketToggleChange = index.createEvent(this, "marketToggleChange", 7);
        this.checked = false;
        this.disabled = false;
        this.focused = false;
        this.hovered = false;
    ...
    render() {
        return (index.h(index.Host, { key: '951c262c523b48e73f7eac8a34f466946a2f7daa', class: "market-toggle", onBlur: () => {
                this.setFocus(false);
            }, onClick: this.handleClick, onFocus: () => {
                this.setFocus();
            } }, index.h("input", { key: '4ab242da6a76ba4472ad14478d8f07f4d82c3a77', ref: (el) => (this.innerInput = el), type: "checkbox", role: "switch", "aria-label": aria.getControlInputAriaLabel(this.el), checked: this.checked, disabled: this.disabled }), index.h("svg", { key: 'f990289d9d5d1f06609c1b4e065e34525ea4e11f', width: "40", height: "24", viewBox: "0 0 40 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", "aria-hidden": "true" }, index.h("rect", { key: '88fcdb713db813a007e1cc07fa9a2562136e1134', x: "1", y: "1", width: "38", height: "22", rx: "11", "stroke-width": "2" }), index.h("circle", { key: '10e6d92b7936078bc9a2f7a43253c58448c126ca', cx: "12", cy: "12", r: "7" }))));
    }
    get el() { return index.getElement(this); }
};
MarketToggle.style = MarketToggleStyle0;

exports.market_toggle = MarketToggle;

//# sourceMappingURL=market-toggle.cjs.entry.js.map