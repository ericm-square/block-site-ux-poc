...
const MarketStepper = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.marketStepperValueChange = index.createEvent(this, "marketStepperValueChange", 7);
        this.marketStepperInputFocus = index.createEvent(this, "marketStepperInputFocus", 7);
    ...
    render() {
        return (index.h(index.Host, { key: '4fa66a3ae5b2e85fc2c0930c0c7662fd13a73109', class: "market-stepper", onFocus: () => {
                this.focused = true;
            }, onBlur: () => {
                this.focused = false;
            } }, index.h("button", { key: 'd0b486eb97f7d2f277ef7077da51a3736b4e11cb', tabindex: this.disabled || this.decrementDisabled ? -1 : null, disabled: this.disabled || this.decrementDisabled, onClick: () => this.onDecrementClick(), "aria-label": this.decrementAriaLabel }, index.h("svg", { key: '1f49587ce03a3ac77437e68b9acec58e675870a7', width: "10", height: "2", viewBox: "0 0 10 2", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: '22eed75f2afcf818339fb56f4afa5b6d8615127f', d: "M9.66667 0.333328H0.333336V1.66666H9.66667V0.333328Z" }))), index.h("input", { key: 'cd43e7befba83e6666deb680801145ed3cc92323', ref: (el) => (this.inputEl = el), type: "number", id: this.inputId, name: this.name, readonly: this.readonly, disabled: this.disabled, placeholder: this.placeholder, step: this.step, min: this.min, max: this.max, value: this.value, "aria-label": this.inputAriaLabel, onChange: () => this.onChange(), onFocus: () => this.onInputFocus(), onKeyDown: (e) => this.onKeyDown(e), part: "native-input" }), index.h("button", { key: '6b2e74af300494bfac3c3796d369421e163dda06', tabindex: this.disabled || this.incrementDisabled ? -1 : null, disabled: this.disabled || this.incrementDisabled, onClick: () => this.onIncrementClick(), "aria-label": this.incrementAriaLabel }, index.h("svg", { key: 'b8ee04c78ce8c07cc16e4b47d761db6f359dee2b', width: "10", height: "10", viewBox: "0 0 10 10", xmlns: "http://www.w3.org/2000/svg" }, index.h("path", { key: 'bbd4fa4531041fada7b5e5794d33d0be968033a6', d: "M5.66665 9.66666V5.66666H9.66665V4.33333H5.66665V0.333328H4.33331V4.33333H0.333313V5.66666H4.33331V9.66666H5.66665Z" })))));
    }
...
MarketStepper.style = MarketStepperStyle0;

exports.market_stepper = MarketStepper;

//# sourceMappingURL=market-stepper.cjs.entry.js.map