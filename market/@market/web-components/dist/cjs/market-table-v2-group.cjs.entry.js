...
const MarketTableV2Group = class {
    constructor(hostRef) {
        ...
        this.marketInternalTableV2GroupSelectionChange = index.createEvent(this, "marketInternalTableV2GroupSelectionChange", 7);
        this.marketTableV2RowsReordered = index.createEvent(this, "marketTableV2RowsReordered", 7);
        this.marketTableV2GroupCollapsedChange = index.createEvent(this, "marketTableV2GroupCollapsedChange", 7);
    ...
    getElements() {
        this.parent = [...this.el.children].find((child) => {
            return child.tagName === index$1.getNamespacedTagFor('market-table-v2-row').toUpperCase() && child.slot === 'parent';
        });
        this.rows = [...this.el.children].filter((child) => {
            return child.tagName === index$1.getNamespacedTagFor('market-table-v2-row').toUpperCase() && child.slot !== 'parent';
        });
        this.groups = [...this.el.children].filter((child) => {
            return child.tagName === index$1.getNamespacedTagFor('market-table-v2-group').toUpperCase() && child.slot !== 'parent';
        });
    ...
    render() {
        return (index.h(index.Host, { key: 'dabd9bc7e9c87046618544958c5fea00a375c631', class: "market-table-v2-group", style: this.getStyles() }, index.h("slot", { key: 'd5893440e44dc0014fd3921e5eb46f8e31a32813', name: "parent", onSlotchange: () => this.onSlotChange() }), index.h("div", { key: '876dbab692978351ceb9f70358fe82b76d80d174', class: "children" }, index.h("slot", { key: '11071473d3ca6f7b7619258c2bef6bcd987a4a95', onSlotchange: () => this.onSlotChange() }))));
    }
...
exports.market_table_v2_group = MarketTableV2Group;

//# sourceMappingURL=market-table-v2-group.cjs.entry.js.map