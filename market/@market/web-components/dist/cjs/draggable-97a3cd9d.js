...
function isMarketTableV2Row(value) {
    ...
    return Boolean(value && tagName === index.getNamespacedTagFor('market-table-v2-row'));
}

function isMarketTableV2Group(value) {
    const tagName = value === null || value === void 0 ? void 0 : value.tagName.toLowerCase();
    return Boolean(value && tagName === index.getNamespacedTagFor('market-table-v2-group'));
}
...
const MarketTableV2GroupTag = index.getNamespacedTagFor('market-table-v2-group');
/*
...
class Draggable {
    ...
    async start(coords) {
        ...
        Object.assign(clone.style, {
            ...
            zIndex: `${maxZIndex.getMaxZIndex(document.body) + 1}`,
        });
        await raf.asyncRequestAnimationFrame();
...
exports.isMarketTableV2Group = isMarketTableV2Group;
exports.isMarketTableV2Row = isMarketTableV2Row;

//# sourceMappingURL=draggable-97a3cd9d.js.map