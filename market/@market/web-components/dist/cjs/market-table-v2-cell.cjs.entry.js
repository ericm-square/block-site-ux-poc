...
function isMarketCheckbox(value) {
    ...
    return Boolean(value && tagName === index.getNamespacedTagFor('market-checkbox'));
}

function isMarketToggle(value) {
    var _a;
    const tagName = (_a = value === null || value === void 0 ? void 0 : value.tagName) === null || _a === void 0 ? void 0 : _a.toLowerCase();
    return Boolean(value && tagName === index.getNamespacedTagFor('market-toggle'));
}
...
const MarketTableV2Cell = class {
    constructor(hostRef) {
        index$1.registerInstance(this, hostRef);
        this.marketTableV2CellCaretClicked = index$1.createEvent(this, "marketTableV2CellCaretClicked", 7);
        this.marketTableV2CellSortClicked = index$1.createEvent(this, "marketTableV2CellSortClicked", 7);
        this.marketInternalTableV2CellSelectionChange = index$1.createEvent(this, "marketInternalTableV2CellSelectionChange", 7);
        this.active = false;
    ...
    renderCaretButton() {
        ...
        index$1.h("button", { class: "caret-button", "aria-label": this.caret === 'down' ? this.caretAriaLabelCollapsed : this.caretAriaLabelExpanded, onClick: (e) => this.onCaretClick(e) }, index$1.h("svg", { width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, index$1.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.70715 11.7071C8.31663 12.0976 7.68346 12.0976 7.29294 11.7071L1.29294 5.70711L2.70715 4.29289L8.00005 9.58579L13.2929 4.29289L14.7072 5.70711L8.70715 11.7071Z" }))));
    }
    renderSortAscendingSvg() {
        return (index$1.h("svg", { width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, index$1.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M7.52861 2.86177C7.78895 2.60142 8.21107 2.60142 8.47141 2.86177L13.1381 7.52843L12.1953 8.47124L8.66668 4.94265L8.66668 12.6665H7.33334V4.94265L3.80475 8.47124L2.86194 7.52843L7.52861 2.86177Z" })));
    }
    renderSortDecendingSvg() {
        return (index$1.h("svg", { width: "16", height: "16", viewBox: "0 0 16 16", xmlns: "http://www.w3.org/2000/svg" }, index$1.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M8.47129 13.1382C8.21094 13.3986 7.78883 13.3986 7.52848 13.1382L2.86182 8.47157L3.80463 7.52876L7.33322 11.0574L7.33322 3.3335L8.66655 3.3335L8.66655 11.0574L12.1952 7.52876L13.138 8.47157L8.47129 13.1382Z" })));
    }
    renderSortNoneSvg() {
        return (index$1.h("svg", { width: "16", height: "17", viewBox: "0 0 16 17", xmlns: "http://www.w3.org/2000/svg" }, index$1.h("path", { "fill-rule": "evenodd", "clip-rule": "evenodd", d: "M10.8633 14.31L8.19664 11.6434L9.1433 10.7034L10.67 12.23L10.67 3.17002L12.0033 3.17002L12.0033 12.23L13.53 10.7034L14.47 11.6434L11.8033 14.31C11.5433 14.57 11.1233 14.57 10.8633 14.31ZM2.46997 6.30338L1.52997 5.36338L4.19664 2.69671C4.45664 2.43671 4.87664 2.43671 5.13664 2.69671L7.8033 5.36338L6.8633 6.30338L5.33664 4.77671L5.33664 13.8367L4.0033 13.8367L4.0033 4.77671L2.46997 6.30338Z" })));
    }
    renderSortSvg() {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, { key: '2d295a766cd4cb793b862dd91fc75268c2a87dd4', role: (_a = el.role) !== null && _a !== void 0 ? _a : 'cell', tabindex: this.getTabIndex(), style: this.getStyles(), class: "market-table-v2-cell", "sort-order": sortOrder !== 'none' ? sortOrder : null, "aria-sort": sortOrder !== 'none' ? sortOrder : null }, index$1.h("div", { key: '906e275506a64e166a30803cfc82c62f777ed6d3', class: "content-outer" }, caret && this.renderCaretButton(), index$1.h("slot", { key: 'ac57aa86c019e676af0bb682c62566edafd49ac9', name: "control", onSlotchange: () => this.syncControlState() }), index$1.h("div", { key: '2a4230ff9f54efa8ee8cee84520d33dd825dde2c', class: "content-inner" }, index$1.h("slot", { key: '99ed0e6392d5578d91f4241e327ff35b94f0b399', name: "leading-accessory" }), index$1.h("div", { key: 'bfd35740621d1e2ae479b6a0f04f6f4d0cbe44bf', class: "default-slot" }, !sortable && index$1.h("slot", { key: 'dd7101744adee33b83c23edd386ae2f5569a3b08' }), sortable && (index$1.h("button", { key: 'b50edf4b821d5d7b558403069525a2094c7074fb', class: "sort-button", "aria-describedby": "sort-button-label", onClick: () => this.onSortClick() }, index$1.h("slot", { key: '6b025eba66325233948b4049c8f4488811a5bd56' }), this.renderSortSvg(), index$1.h("span", { key: 'd3fbf14b0b8cce540086ad7085ae39fc534c659d', id: "sort-button-label", hidden: true }, this.getSortButtonLabel())))), index$1.h("slot", { key: 'ff30de7fc804ca8308dc6a997c22449fdc14307b', name: "trailing-accessory" })))));
    }
    get el() { return index$1.getElement(this); }
};
MarketTableV2Cell.style = MarketTableV2CellStyle0;

exports.market_table_v2_cell = MarketTableV2Cell;

//# sourceMappingURL=market-table-v2-cell.cjs.entry.js.map