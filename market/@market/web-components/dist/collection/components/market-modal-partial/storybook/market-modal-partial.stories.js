...
import { MarketModalPartialTemplate } from "./market-modal-partial.templates";
export default {
    title: 'Components/Modals/Partial Modal/API',
    component: 'market-modal-partial',
    argTypes: {
        // demo
        actions: {
            name: 'Actions',
...
export const API = {
    render: (args) => MarketModalPartialTemplate(args),
    decorators: [
        (story, { viewMode }) => {
...
//# sourceMappingURL=market-modal-partial.stories.js.map
