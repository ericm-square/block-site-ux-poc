...
describe('market-table-v2-row: drag enabled', () => {
    describe('initialization', () => {
        ...
        <market-table-v2-row drag-enabled>
          <market-table-v2-cell>Content</market-table-v2-cell>
        </market-table-v2-row>
      `);
            row = await page.find('market-table-v2-row');
        });
    ...
    describe('drag & drop', () => {
        ...
        beforeEach(async () => {
            ...
            await page.setContent(`
        <market-table-v2 reorderable="internal" style="position: absolute; left: 0; top: 0; width: 200px; z-index: 2;">
          <market-table-v2-row
            drag-enabled
      ...
      `);
        ...
        describe('when the drag starts', () => {
            ...
            it('clones and appends a dummy row', async () => {
                const clone = await page.find('market-table-v2-row.market-drag-clone');
        ...
        describe('when preventDefault() is called on drag start', () => {
            beforeEach(async () => {
                await page.$eval('market-table-v2-row', (el) => {
    ...
    describe('drag & scroll', () => {
        ...
        <div class="scroll-container" style="position: absolute; left: 0; top: 500px; height: 100px; width: 200px; overflow: scroll;">
          <div class="scroll-content" style="height: 1000px;">
            <market-table-v2 reorderable="internal">
              <market-table-v2-row
                drag-enabled
                drag-handle-position="leading"
              >
      ...
      `);
        ...
        describe('when the row is dragged to the bottom of a scrollable container', () => {
            beforeEach(async () => {
                ...
                await new Promise((r) => setTimeout(r, CORE_ANIMATION_MOVE_TRANSITION_MODERATE_SPEED_DURATION + 1));
                await page.waitForChanges();
                await page.mouse.move(20, 1000); // drag below the bottom of scroll container
                await new Promise((r) => setTimeout(r, SCROLL_TIME + 1)); // wait for scroll to complete
                await page.waitForChanges();
            });
            ...
            describe('when the row is dragged to the top of the scrollable container', () => {
                beforeEach(async () => {
                    await page.mouse.move(20, 0); // drag back above the top of scroll container
                    await page.waitForChanges();
                    await new Promise((r) => setTimeout(r, SCROLL_TIME + 1)); // wait for scroll to complete
                    await page.waitForChanges();
                });
...
//# sourceMappingURL=market-table-v2-row.drag.e2e.js.map
