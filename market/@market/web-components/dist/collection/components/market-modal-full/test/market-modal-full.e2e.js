...
describe('market-modal-full', () => {
    it('renders with defaults', async () => {
        const page = await newE2EPage();
        await page.setContent('<market-modal-full></market-modal-full>');
        const el = await page.find('market-modal-full');
    ...
    describe('a11y', () => {
        ...
        <market-modal-full aria-label="Test hidden label">
        </market-modal-full>
      `);
            const element = await page.find('market-modal-full');
            expect(element).toEqualAttribute('aria-label', 'Test hidden label');
        });
        it('allows aria-labelledby to be set', async () => {
            const page = await newE2EPage();
            await page.setContent(`
        <market-modal-full aria-labelledby="test-label">
    ...
    describe('when a header and main are present', () => {
        ...
        beforeEach(async () => {
            ...
            await page.setContent(`<market-modal-full style="height: 200px">
    ...
    describe.skip('focus trap', () => {
      ...
      `);
            const modal = await page.find('market-modal-full');
...
//# sourceMappingURL=market-modal-full.e2e.js.map
