...
export class MarketDragHandle {
    ...
    static get is() { return "market-drag-handle"; }
    static get encapsulation() { return "shadow"; }
    static get originalStyleUrls() {
        return {
            "$": ["market-drag-handle.css"]
        };
    }
    ...
    static get events() {
        return [{
                "method": "marketDragHandleDragStart",
                ...
                "docs": {
                    "tags": [],
                    "text": "Fired whenever a drag is started."
                },
                "complexType": {
                ...
                "method": "marketDragHandleDragMove",
                ...
                "docs": {
                    "tags": [],
                    "text": "Fired whenever a drag is moved."
                },
                "complexType": {
                    "original": "TMarketDragCoords",
                    "resolved": "{ x: number; y: number; }",
                ...
                "method": "marketDragHandleDragEnd",
                ...
                "docs": {
                    "tags": [],
                    "text": "Fired whenever a drag is ended."
                },
                "complexType": {
                    "original": "TMarketDragCoords",
                    "resolved": "{ x: number; y: number; }",
