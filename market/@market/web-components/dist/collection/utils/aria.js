 ...
 */
export const observeAriaAttributes = (el, onMutationObserved) => {
 ...
 */
export const getTextInputAriaLabel = (inputEl) => {
    var _a;
    const slottedLabel = 
 ...
 */
export const getControlInputAriaLabel = (controlEl) => {
    var _a;
...
export const applyExpandableAriaControls = (controlEl, { expanded, popoverId }) => {
